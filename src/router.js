...
router.beforeEach((to, from, next) => {
    ...
    if(to.name == "Login"  && localStorage.getItem("email_login") != null ||
    ...
    //jika belum login
    if(to.name == "Dashboard" && localStorage.getItem("email_login") == null ||
    to.name == "DriverPegawai" && localStorage.getItem("email_login") == null ||
    to.name == "PemilikMobilPegawai" && localStorage.getItem("email_login") == null ||
    to.name == "PromoPegawai" && localStorage.getItem("email_login") == null ||
    to.name == "JabatanPegawai" && localStorage.getItem("email_login") == null ||
    to.name == "JadwalPegawai" && localStorage.getItem("email_login") == null ||
    to.name == "CustomerPegawai" && localStorage.getItem("email_login") == null ||
    to.name == "AsetMobilPegawai" && localStorage.getItem("email_login") == null ||
    to.name == "DetailJadwalPegawai" && localStorage.getItem("email_login") == null ||
    to.name == "Pegawai" && localStorage.getItem("email_login") == null ||
    to.name == "transaksiPegawai" && localStorage.getItem("email_login") == null ||
    to.name == "DetailTransaksiPegawai" && localStorage.getItem("email_login") == null ||
    to.name == "PromoCustomer" && localStorage.getItem("email_login") == null ||
    to.name == "ProfileCustomer" && localStorage.getItem("email_login") == null ||
    to.name == "ProfilePegawai" && localStorage.getItem("email_login") == null ||
    to.name == "AsetMobilCustomer" && localStorage.getItem("email_login") == null ||
    ...
    if(to.name == "Promo" && localStorage.getItem("email_login") != null && localStorage.getItem("id_jabatan") !="1" ||
    to.name == "JadwalPegawai" && localStorage.getItem("email_login") != null && localStorage.getItem("id_jabatan") !="1" ||
    to.name == "JabatanPegawai" && localStorage.getItem("email_login") != null && localStorage.getItem("id_jabatan") !="1"){
        next({ name: "Index" })
        document.to.meta.title = "Index"
    }

    //role customer service hanya dapat mengelola customer, transaksi, detail transaksi
    if(to.name == "CustomerPegawai" && localStorage.getItem("email_login") != null && localStorage.getItem("id_jabatan") !="2" ||
    to.name == "transaksiPegawai" && localStorage.getItem("email_login") != null && localStorage.getItem("id_jabatan") !="2" ||
    to.name == "DetailTransaksiPegawai" && localStorage.getItem("email_login") != null && localStorage.getItem("id_jabatan") !="2"){
        next({ name: "Index" })
        document.to.meta.title = "Index"
    }

    //role admin hanya dapat mengelola pemilik mobil, aset mobil, pegawai, jabatan, driver
    if(to.name == "PemilikMobilPegawai" && localStorage.getItem("email_login") != null && localStorage.getItem("id_jabatan") !="3" ||
    to.name == "DriverPegawai" && localStorage.getItem("email_login") != null && localStorage.getItem("id_jabatan") !="3" ||
    to.name == "AsetMobilPegawai" && localStorage.getItem("email_login") != null && localStorage.getItem("id_jabatan") !="3" ||
    to.name == "Pegawai" && localStorage.getItem("email_login") != null && localStorage.getItem("id_jabatan") !="3" ||
    to.name == "JabatanPegawai" && localStorage.getItem("email_login") != null && localStorage.getItem("id_jabatan") !="3"){
        next({ name: "Index" })
        document.to.meta.title = "Index"
    }
