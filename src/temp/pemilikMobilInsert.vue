                            ...
                            <div>
                                <v-form v-model="valid" ref="form">
                                    <div class="mb3">
                                        ...
                                        <v-text-field v-model="nama_pemilik_mobil" :rules="namaPemilikRules" required
                                    ...
                                    <div class="mb3">
                                        ...
                                        <v-text-field v-model="no_ktp_pemilik_mobil" :rules="noKTPRules" required filled
                                    ...
                                    <div class="mb3">
                                        ...
                                        <v-text-field dense filled v-model="alamat_pemilik_mobil"
                                            :rules="alamatPemilikRules" required label="Masukkan Alamat">
                                        </v-text-field>
                                    </div>
                                    ...
                                    <div class="mb3">
                                        ...
                                        <v-text-field filled v-model="nomor_telepon_pemilik_mobil" :rules="noTelpRules"
                                    ...
                                    <div class="mb3">
                                        <p class="text-start" style="margin-bottom: 5px;">
                                            <strong style="font-size: 15px !important">Periode Kontrak Mulai</strong>
                                        </p>
                                        <date-picker v-model="periode_kontrak_mulai_mobil" valueType="format">
                                        </date-picker>
                                    </div>

                                    <div class="mb3">
                                        <p class="text-start" style="margin-bottom: 5px;">
                                            <strong style="font-size: 15px !important">Periode Kontrak Akhir</strong>
                                        </p>
                                        <date-picker v-model="periode_kontrak_akhir_mobil" valueType="format">
                                        </date-picker>
                                    </div>

                                    <div class="mb3">
                                        <p class="text-start" style="margin-bottom: 5px;">
                                            <strong style="font-size: 15px !important">Tanggal Terakhir Servis</strong>
                                        </p>
                                        <date-picker v-model="tanggal_terakhir_servis_mobil" valueType="format">
                                        </date-picker>
                                    </div>

                                    <v-layout justify-center>
                                        <v-btn class="btn btn-primary d-block w-100 white--text" @click="submit"
                                            style="background: #ff7d00; margin-right: 8px" name="insertPemilik">
                                            Submit
                                        </v-btn>
                                    </v-layout>
        ...
        methods: {
            submit() {
                if (this.$refs.form.validate()) {
                    ...
                    this.load = true;
                    this.$http.post(this.$api + '/pemilik-mobil', {
