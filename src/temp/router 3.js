...
router.beforeEach((to, from, next) => {
    ...
    //Hanya Manager yang bisa melihat halaman promo, jadwal, detail jadwal
    if(to.name == "Promo" && localStorage.getItem("id_jabatan") != "1" && localStorage.getItem("email") != null ||
    ...
    //Hanya Admin yang bisa melihat halaman jabatan, pemilik, driver, pegawai, mobil
    if(to.name == "Jabatan" && localStorage.getItem("id_jabatan") != "2" && localStorage.getItem("email") != null ||
        to.name == "Pemilik" && localStorage.getItem("id_jabatan") != "2" && localStorage.getItem("email") != null ||
