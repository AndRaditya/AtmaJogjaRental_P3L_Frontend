	...
	<v-main class="list">
				...
				<v-form ref="form" v-model="valid" lazy-validation>
					<v-card-text>
						<v-container>
							...
							<v-text-field
								filled
								v-model="form.nomor_telepon_driver"
								required
							...
							<v-select
								...
								:items="['Indonesia', 'Indonesia, English']"
							...
							<v-text-field
								prefix="Rp"
								filled
								v-model="form.tarif_driver_harian"
							...
							<v-file-input
								...
								id="fileSuratNapzaDriver"
								ref="tampilNapzaDriver"
							>
							</v-file-input>
							<v-file-input
								filled
								...
								id="fileSuratJiwaDriver"
								ref="tampilSuratJiwaDriver"
							>
							</v-file-input>
							<v-file-input
								filled
								prepend-icon="mdi-camera"
								label="Upload Surat Kesehatan Jasmani"
								id="fileSuratJasmaniDriver"
								ref="tampilSuratJasmaniDriver"
							>
							</v-file-input>
							<v-file-input
								filled
								prepend-icon="mdi-camera"
								label="Upload Surat Keterangan Catatan Kepolisian (SKCK) "
								id="fileSKCKDriver"
		...
		>
			<v-card
				...
				"
			>
				<span class="headline">Foto SIM</span>
				<v-img
					width="550px"
					:src="
						previewImageUrl == ''
							? $baseUrl + '/storage/' + form.foto_sim
							: previewImageUrl
					"
					id="previewImage"
				...
				<span class="headline">Surat Bebas Napza</span>
				<v-img
					width="550px"
					:src="
						previewImageNapza == ''
							? $baseUrl + '/storage/' + form.surat_napza
							: previewImageNapza
					"
					id="previewImageNapza"
					class="mb-5 ml-4 mt-4"
				>
				</v-img>
				<span class="headline">Surat Kesehatan Jiwa</span>
				<v-img
					width="550px"
					:src="
						previewImageSuratJiwa == ''
							? $baseUrl + '/storage/' + form.surat_kesehatan_jiwa
							: previewImageSuratJiwa
					"
					id="previewImageSuratJiwa"
					class="mb-5 ml-4 mt-4"
				>
				</v-img>
				<span class="headline">Surat Kesehatan Jasmani</span>
				<v-img
					width="550px"
					:src="
						previewImageSuratJasmani == ''
							? $baseUrl +
							  '/storage/' +
							  form.surat_kesehatan_jasmani
							: previewImageSuratJasmani
					"
				...
				<span class="headline">SKCK</span>
				<v-img
					width="550px"
					:src="
						previewImageSKCK == ''
							? $baseUrl + '/storage/' + form.skck
							: previewImageSKCK
					"
					id="previewImageSKCK"
					class="mb-5 ml-4 mt-4"
...
export default {
	...
	methods: {
		onPreviewimage(e) {
			...
			this.previewImageNapza = URL.createObjectURL(e);
			this.previewImageSuratJiwa = URL.createObjectURL(e);
			this.previewImageSuratJasmani = URL.createObjectURL(e);
			this.previewImageSKCK = URL.createObjectURL(e);
		},
		setForm() {
		...
		save() {
			{
				...
				this.driver.append(
					...
					this.form.nomor_telepon_driver
				);
				...
				this.driver.append(
					'tarif_driver_harian',
					this.form.tarif_driver_harian
				);
				this.driver.append(
					'password_driver',
					this.form.password_driver
				);
		...
		deleteHandler(item) {
			this.deleteId = item.id_driver_increment;
			this.dialogConfirm = true;
		},
		dialogDetailHandler(driver) {
			this.editId = driver.id_driver_increment;
			this.form.foto_sim = driver.foto_sim;
			this.form.surat_napza = driver.surat_napza;
			this.form.surat_kesehatan_jiwa = driver.surat_kesehatan_jiwa;
			this.form.surat_kesehatan_jasmani = driver.surat_kesehatan_jasmani;
			this.form.skck = driver.skck;
