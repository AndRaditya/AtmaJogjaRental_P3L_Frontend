<template>
    <v-main class="list">
        <h3 class="text-h3" font-weight-medium mb-5 style="margin-top: 150px">Pemilik Mobil</h3>
        ...
        <v-data-table :headers="headers" :items="pemiliks" :search="search" :single-expand="singleExpand"
        ...
        <v-dialog v-model="dialog" persistent width="1000px" content-class="elevation-0">
            <v-card style="margin-top: 150px">
                ...
                <v-form ref="form" v-model="valid" lazy-validation>
                    <v-card-text>
                        <v-container>
                            <v-text-field v-model="form.nama_pemilik_mobil" required filled
                                label="Masukkan Nama Lengkap">
                            </v-text-field>
                            <v-textarea v-model="form.alamat_pemilik_mobil" required filled label="Masukkan Alamat">
                            </v-textarea>
                            <v-text-field filled v-model="form.nomor_telepon_pemilik_mobil" required
                                label="Masukkan Nomor Telepon" type="number" counter="13">
                            </v-text-field>
                            <v-text-field filled v-model="form.no_ktp_pemilik_mobil" required
                                label="Masukkan Nomor KTP" type="number" counter="16">
                            </v-text-field>
                            <v-text-field filled v-model="form.periode_kontrak_mulai_mobil" required
                                label="Masukkan Periode Kontrak Mulai" type="date">
                            </v-text-field>
                            <v-text-field filled v-model="form.periode_kontrak_akhir_mobil" required
                                label="Masukkan Periode Kontrak Akhir" type="date">
                            </v-text-field>
                            <v-text-field filled v-model="form.tanggal_terakhir_servis_mobil" required
                                label="Masukkan Tanggal Terakhir Servis" type="date">
                            </v-text-field>
                        </v-container>
                    </v-card-text>
...
<script>
    export default {
        ...
        methods: {
            ...
            save() {
                {
                    this.pemilik.append("nama_pemilik_mobil", this.form.nama_pemilik_mobil);
                    this.pemilik.append("alamat_pemilik_mobil", this.form.alamat_pemilik_mobil);
                    this.pemilik.append("nomor_telepon_pemilik_mobil", this.form.nomor_telepon_pemilik_mobil);
                    this.pemilik.append("no_ktp_pemilik_mobil", this.form.no_ktp_pemilik_mobil);
                    this.pemilik.append("periode_kontrak_mulai_mobil", this.form.periode_kontrak_mulai_mobil);
                    this.pemilik.append("periode_kontrak_akhir_mobil", this.form.periode_kontrak_akhir_mobil);
                    this.pemilik.append("tanggal_terakhir_servis_mobil", this.form.tanggal_terakhir_servis_mobil);
            ...
            update() {
                let newData = {
                    ...
                    nomor_telepon_pemilik_mobil: this.form.nomor_telepon_pemilik_mobil,
            ...
            editHandler(pemilik) {
                ...
                this.form.nomor_telepon_pemilik_mobil = pemilik.nomor_telepon_pemilik_mobil;
                this.form.no_ktp_pemilik_mobil = pemilik.no_ktp_pemilik_mobil;
                this.form.periode_kontrak_mulai_mobil = pemilik.periode_kontrak_mulai_mobil;
                this.form.periode_kontrak_akhir_mobil = pemilik.periode_kontrak_akhir_mobil;
                this.form.tanggal_terakhir_servis_mobil = pemilik.tanggal_terakhir_servis_mobil;
                this.dialog = true;
            },
            deleteHandler(item) {
