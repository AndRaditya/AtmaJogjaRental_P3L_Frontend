<template>
    <v-main class="list">
        <h3 class="text-h3" font-weight-medium mb-5 style="margin-top: 150px">Aset Mobil</h3>
        ...
        <v-dialog v-model="dialog" persistent width="1000px" content-class="elevation-0">
            <v-card style="margin-top: 150px">
                ...
                <v-form ref="form" lazy-validation>
                    <v-card-text>
                        <v-container>
                            <v-text-field v-model="form.plat_nomor_mobil" required filled
                                label="Masukkan Plat Nomor">
                            </v-text-field>

                            <v-select icon="mdi-clear" clearable :items="pemiliks" v-model="form.id_pemilik_mobil" required filled
                                label="Masukkan Nama Pemilik" item-value="id_pemilik_mobil"
                                item-text="nama_pemilik_mobil">
                            </v-select>

                            <v-text-field v-model="form.nama_mobil" required filled label="Masukkan Nama Mobil">
                            </v-text-field>
                            <v-select icon="mdi-clear" clearable filled v-model="form.tipe_mobil" :items="['Sedan', 'City Car', 'SUV', 'MPV']"
                                label="Masukkan Tipe Mobil" required>
                            </v-select>
                            <v-select icon="mdi-clear" clearable filled v-model="form.jenis_transmisi_mobil" :items="['AT', 'MT', 'CVT']"
                                label="Masukkan Jenis Transmisi" required>
                            </v-select>
                            <v-select icon="mdi-clear" clearable filled v-model="form.jenis_bahanbakar_mobil"
                                :items="['Pertamax', 'Pertalite']" label="Masukkan Jenis Bahan Bakar" required>
                            </v-select>
                            <v-text-field filled prefix="L" v-model="form.volume_bahanbakar_mobil" require
                                label="Masukkan Volume Bahan Bakar" type="number">
                            </v-text-field>
                            <v-text-field filled v-model="form.warna_mobil" required label="Masukkan Warna Mobil">
                            </v-text-field>
                            <v-text-field filled v-model="form.kapasitas_penumpang_mobil" required
                                label="Masukkan Kapasitas Penumpang" type="number">
                            </v-text-field>
                            <v-text-field filled v-model="form.fasilitas_mobil" required
                                label="Masukkan Fasilitas Mobil">
                            </v-text-field>
                            <v-text-field filled v-model="form.nomor_stnk_mobil" required
                                label="Masukkan Nomor STNK Mobil" counter>
                            </v-text-field>
                            <v-text-field prefix="Rp" filled v-model="form.harga_sewa_mobil" required
                                label="Masukkan Harga Sewa Mobil" type="number">
                            </v-text-field>
                            <v-text-field prefix="L" filled v-model="form.volume_bagasi_mobil" required
                                label="Masukkan Volume Bagasi Mobil" type="number">
                            </v-text-field>
        ...
        <v-dialog v-model="dialogConfirm" persistent width="400px">
            <v-card>
                ...
                <v-card-text> Anda Yakin ingin menghapus aset mobil ini? </v-card-text>
                <v-card-action>
                    <v-spacer></v-spacer>
...
<script>
    export default {
        ...
        methods: {
            ...
            save() {
                {
                    this.aset_mobil.append("plat_nomor_mobil", this.form.plat_nomor_mobil);
                    if(this.form.id_pemilik_mobil > 0){
                        this.aset_mobil.append("id_pemilik_mobil", this.form.id_pemilik_mobil);
                    }else{
                    ...
                    this.aset_mobil.append("jenis_transmisi_mobil", this.form.jenis_transmisi_mobil);
                    this.aset_mobil.append("jenis_bahanbakar_mobil", this.form.jenis_bahanbakar_mobil);
                    this.aset_mobil.append("volume_bahanbakar_mobil", this.form.volume_bahanbakar_mobil);
                    this.aset_mobil.append("warna_mobil", this.form.warna_mobil);
                    this.aset_mobil.append("kapasitas_penumpang_mobil", this.form.kapasitas_penumpang_mobil);
                    this.aset_mobil.append("fasilitas_mobil", this.form.fasilitas_mobil);
                    this.aset_mobil.append("nomor_stnk_mobil", this.form.nomor_stnk_mobil);
                    this.aset_mobil.append("harga_sewa_mobil", this.form.harga_sewa_mobil);
                    this.aset_mobil.append("volume_bagasi_mobil", this.form.volume_bagasi_mobil);
            ...
            update() {
                ...
                // data.aset_mobil.append("plat_nomor_mobil", this.form.plat_nomor_mobil);
                // // if(this.form.id_pemilik_mobil > 0){
                //     data.aset_mobil.append("id_pemilik_mobil", this.form.id_pemilik_mobil);
                // // }else{
                //     // data.aset_mobil.append("id_pemilik_mobil", 6);
                // // }    
                // data.aset_mobil.append("nama_mobil", this.form.nama_mobil);
                // data.aset_mobil.append("tipe_mobil", this.form.tipe_mobil);
                // data.aset_mobil.append("jenis_transmisi_mobil", this.form.jenis_transmisi_mobil);
                // data.aset_mobil.append("jenis_bahanbakar_mobil", this.form.jenis_bahanbakar_mobil);
                // data.aset_mobil.append("volume_bahanbakar_mobil", this.form.volume_bahanbakar_mobil);
                // data.aset_mobil.append("warna_mobil", this.form.warna_mobil);
                // data.aset_mobil.append("kapasitas_penumpang_mobil", this.form.kapasitas_penumpang_mobil);
                // data.aset_mobil.append("fasilitas_mobil", this.form.fasilitas_mobil);
                // data.aset_mobil.append("nomor_stnk_mobil", this.form.nomor_stnk_mobil);
                // data.aset_mobil.append("harga_sewa_mobil", this.form.harga_sewa_mobil);
                // data.aset_mobil.append("volume_bagasi_mobil", this.form.volume_bagasi_mobil);
            ...
            editHandler(aset_mobil) {
                ...
                this.form.jenis_bahanbakar_mobil = aset_mobil.jenis_bahanbakar_mobil;
                this.form.volume_bahanbakar_mobil = aset_mobil.volume_bahanbakar_mobil;
                this.form.warna_mobil = aset_mobil.warna_mobil;
                this.form.kapasitas_penumpang_mobil = aset_mobil.kapasitas_penumpang_mobil;
