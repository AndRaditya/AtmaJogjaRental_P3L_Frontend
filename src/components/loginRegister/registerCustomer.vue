            ...
            <v-layout flex align-center justify-center>
                <v-flex sm12 sm4>
                    <v-card style="elevation">
                        ...
                        <h2 style="padding-top: 14px; font-family: Anton, sans-serif; font-size: 30px !important">
                            Customer
                        </h2>
                            ...
                            <div>
                                <v-form v-model="valid" ref="form">
                                    <div class="mb3">
                                        ...
                                        <v-text-field v-model="form.nama_customer" :rules="namaCustomerRules" required
                                            filled label="Masukkan Nama Lengkap"></v-text-field>
                                    </div>
                                    ...
                                    <div class="mb3">
                                        ...
                                        <v-text-field v-model="form.email_customer" :rules="emailRules" required filled
                                    ...
                                    <div class="mb3">
                                        ...
                                        <v-text-field filled v-model="form.nomor_telepon_customer" :rules="noTelpRules"
                                            required label="Masukkan Nomor Telepon" counter="13">
                                        </v-text-field>
                                    </div>
                                    ...
                                    <div class="mb3">
                                        ...
                                        <v-textarea dense filled v-model="form.alamat_customer" :rules="alamatRules"
                                            required label="Masukkan Alamat">
                                        </v-textarea>
                                    </div>
                                    ...
                                    <div class="mb3">
                                        ...
                                        <v-text-field dense filled v-model="form.tanggal_lahir_customer" required
                                            type="date">
                                        </v-text-field>
                                    </div>
                                    ...
                                    <div class="mb3">
                                        ...
                                        <v-select filled v-model="form.jenis_kelamin_customer"
                                            :items="['Laki-laki', 'Perempuan']" label="Masukkan Jenis Kelamin" required>
                                        </v-select>
                                    </div>

                                    <div class="mb3">
                                        <p class="text-start" style="margin-bottom: 5px;">
                                            <strong style="font-size: 15px !important">Nomor KTP</strong>
                                        </p>
                                        <v-text-field filled v-model="form.no_ktp_customer" :rules="noKTPRules" required
                                            label="Masukkan Nomor KTP" counter="16">
                                        </v-text-field>
                                    </div>

                                    <div class="mb3">
                                        <p class="text-start" style="margin-bottom: 5px;">
                                            <strong style="font-size: 15px !important">Nomor SIM</strong>
                                        </p>
                                        <v-text-field filled v-model="form.no_sim_customer" label="Masukkan Nomor SIM">
                                        </v-text-field>
                                    </div>
    ...
    export default {
        ...
        methods: {
            submit() {
                ...
                this.customer.append("nomor_telepon_customer", this.form.nomor_telepon_customer);
